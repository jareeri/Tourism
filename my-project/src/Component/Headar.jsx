...
const Headar = () => {
  ...
  <nav className="relative px-4 py-4 flex justify-between items-center bg-white">
    ...
    <ul className="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
      ...
      <li>
        <Link className="text-sm text-blue-600 font-bold" to="/Blogs">
          blogs
        </Link>
      </li>
    ...
    <Link
      className="hidden lg:inline-block py-2 px-6  bg-gray-800 hover:bg-gray-700 text-sm text-white font-bold rounded-xl transition duration-200"
      to="/SignUp"
    >
      Sign up
    </Link>
    ...
    <nav className="fixed top-0 left-0 bottom-0 flex flex-col w-5/6 max-w-sm py-6 px-6 bg-white border-r overflow-y-auto">
      ...
      <div>
        <ul>
          <li className="mb-1">
            <Link
              className="block p-4 text-sm font-semibold focus:outline-none bg-gray-800 text-white hover:bg-gray-700 hover:shadow-none"
              to="/"
            >
              Home
            </Link>
      ...
      <div className="mt-auto">
        <div className="pt-6">
          ...
          <Link
            className="block px-4 py-3 mb-2 leading-loose text-xs text-center text-white font-semibold bg-gray-800 hover:bg-gray-700  rounded-xl"
            to="/SignUp"
          >
            Sign Up
          </Link>
